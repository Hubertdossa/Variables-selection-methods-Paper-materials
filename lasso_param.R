...
#'   to provide relaxed versions of the lasso solutions, defined by interpolating
#'   in between each solution and the least squares coefficients on the 
#'   corresponding active set. The number of interpolations is governed by the 
#'   nrelax argument; all other arguments are the same.
#'
#' @author D. K. Hubert
#' @export lasso
...
lasso = function(x, y, alpha=1, nrelax=1, nlambda=1,
